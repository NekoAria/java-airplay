...
public class AudioStreamInfo implements MediaStreamInfo {
    ...
    private AudioStreamInfo(CompressionType compressionType, AudioFormat audioFormat, int samplesPerFrame,
                            int sampleRate, int controlPort) {
    ...
    public static final class AudioStreamInfoBuilder {
        ...
        public AudioStreamInfoBuilder sampleRate(int sampleRate) {
            this.sampleRate = sampleRate;
            return this;
        }

        public AudioStreamInfoBuilder controlPort(int controlPort) {
            this.controlPort = controlPort;
            return this;
        }

        public AudioStreamInfo build() {
            return new AudioStreamInfo(compressionType, audioFormat, samplesPerFrame, sampleRate, controlPort);
        }
    }
